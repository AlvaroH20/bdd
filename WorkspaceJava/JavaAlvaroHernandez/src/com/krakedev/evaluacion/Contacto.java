...
public class Contacto {
    ...
    public Contacto(String cedula, String nombre, String apellido, String estado, String telefono) {
        this.cedula = cedula;
        this.nombre = nombre;
        this.apellido = apellido;
        this.estado = estado;
    ...
    public void agregarTelefono(Telefono telefono) {
        if (telefono != null && telefono.getEstado().equals("E")) {
            telefonos.add(telefono);
        }
    }

    public void mostrarTelefonos() {
        System.out.println("Teléfonos con estado 'E':");
        for (Telefono telefono : telefonos) {
            System.out.println("Número: " + telefono.getNumero() + ", Tipo: " + telefono.getTipo());
        }
    }

    public int contarIncorrectos() {
